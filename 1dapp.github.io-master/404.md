...
function SigninPage(){
    ...
    //                    message: "Welcome to FASTBULL V1"
    //                }, {
    //                        type: 'minimalist',
    //                        placement: {
    //                            from: "bottom",
        ...
        try {
            myContractInstance.methods.users(account).call().then(function (result) {
                if (result[0]) {
                    ...
                    location.href = "https://fastbullv1.github.io/Home-Dashboard/";
                }
                else {
                ...
                <div class="login100-form">
                    ...
                    <form class="w-100 validate-form" onsubmit="return false" id="signupform">
                        ...
                        <div class="w-full text-center m-t-30">
                            ...
                            <a href="https://etherscan.io/address/0xd79a94377270673cdc5ab0868d0dfa4dab17a0da" class="text-success" target="_blank">
                                0xd79a94377270673cdc5ab0868d0dfa4dab17a0da <i class="fa fa-external-link"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 text-center d-flex d-block m-t-10">
                        <div class="row">
                            ...
                            <div class="socialjs col-lg-12 m-t-10">
                                ...
                                <a class="sharebutton telegram btn" target="_blank" style="background-color:#0088cc;color:white" href="https://t.me/fastbullv1"><i class="fa fa-telegram"></i> </a>
